...
public class VistaAfegirCorrequisit {
    ...
    private void afegirCorrequisit() {
        String assig = inputCorr.getText();
        System.err.println("DEBUG: vols afegir el correquisit " + assig + " a " + this.assig);
        if (VistaPrincipal.ctrl.existsAssignaturaPE(plaEstudi, assig)) {
