...
public enum Tipus_Aula implements Serializable {
    ...
    public static Tipus_Aula string_to_Tipus_Aula(String s) throws Aula_Exception {
        ...
        if (s.equals("LF") | s.equals("LAB_FISICA") | s.equals("L_FISICA") | s.equals("LABORATORI_FISICA") | s.equals("F") | s.equals("FISICA") | s.equals("L FISICA") | s.equals("LAB FISICA")) return Tipus_Aula.LAB_FISICA;
        if (s.equals("LE") | s.equals("LAB_ELECTRONICA") | s.equals("L_ELECTRONICA") | s.equals("LABORATORI_ELECTRONICA") | s.equals("E") | s.equals("ELECTRONICA") | s.equals("L ELECTRONICA") | s.equals("LAB ELECTRONICA")) return Tipus_Aula.LAB_ELECTRONICA;
        if (s.equals("LI") | s.equals("LAB_INFORMATICA") | s.equals("L_INFORMATICA") | s.equals("LABORATORI_INFORMATICA") | s.equals("I") | s.equals("INFORMATICA") | s.equals("L INFORMATICA") | s.equals("LAB INFORMATICA")) return Tipus_Aula.LAB_INFORMATICA;
    ...
    public static void escriure_codis_valids(PrintStream out){
        ...
        out.println("\t LF | L_FISICA | LAB_FISICA | LABORATORI_FISICA | F | FISICA");

        out.println("Codis valids per " + LAB_ELECTRONICA + ":");
        out.println("\t LE | L_ELECTRONICA | LAB_ELECTRONICA | LABORATORI_ELECTRONICA | E | ELECTRONICA");

        out.println("Codis valids per " + LAB_INFORMATICA + ":");
        out.println("\t LI | L_INFORMATICA | LAB_INFORMATICA | LABORATORI_INFORMATICA | I | INFORMATICA");
    }
